...
function Home(props) {
  ...
  // <HomeProject slug="opaque" name="Opaque" desc=" is a system to minimise, understand and control your 2040 home's data leakage." url="/opaque" topbar={props.topbar} />
  // <HomeProject slug="foto" name="Foto" desc=" is a platform for simplified sharing of moments, with elderly relatives." url="/foto" topbar={props.topbar} />
  ...
  return (
    <div>
        ...
        <Col xs={12} md={7} lg={9} className="project-col">
          ...
          <div className="mb10 jt"><strong>I am in the penultimate year of a 4-year MEng, and always open to hearing about new opportunities - please reach out!</strong>.</div>
